...
def balanced(m):
    ...
    left_tor, right_tor = left_length * total_weight(end(left_arm)), right_length * total_weight(end(right_arm))
    if left_tor != right_tor:
        return False
...
def totals_tree(m):
    ...
    return tree(label, [left_branch, right_branch])
